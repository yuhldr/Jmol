...
public class JvxlCoder {
  ...
  public static void jvxlCreateColorData(JvxlData jvxlData, float[] vertexValues) {
    ...
    float min = (isPrecisionColor ? jvxlData.mappedDataMin : jvxlData.valueMappedToRed);
    float max = (isPrecisionColor ? jvxlData.mappedDataMax : jvxlData.valueMappedToBlue);
   ...
   */
  public static String jvxlEncodeColorData(float[] vertexValues, float min, float max, 
